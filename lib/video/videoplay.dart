...
void main() => runApp(VideoPlay());

class VideoPlay extends StatefulWidget {
  const VideoPlay({Key key, @required this.videoUrl}) : super(key: key);

  final String videoUrl;

  @override
  _MyAppState createState() => _MyAppState(videoUrl: videoUrl);
}

class _MyAppState extends State<VideoPlay> {
  String videoUrl;

  _MyAppState({this.videoUrl});
  ...
  void initState() {
    super.initState();
    print("this.videoUrl ==== " + this.videoUrl);
  }
